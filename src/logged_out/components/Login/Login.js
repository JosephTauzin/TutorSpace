...
function Login(props) {
  ...
  const register = useCallback(() => {
    ...
    if(registerType == null || (registerTest == null && registerType.value == 'Student' ) || registerCompanyCode.current.value == '' || registerPhoneNumber.current.value == '' || registerName.current.value == '' || registerEmail.current.value == '' || registerPassword.current.value == '' || registerPasswordRepeat.current.value == ''){
  ...
  function FindIfCompanyCodeExists(CompanyCode){
    if(CompanyCodesUnique.includes(CompanyCode)){
      return("You are joining an existing company.")
    }
    else{
